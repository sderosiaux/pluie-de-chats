...
export const DIAL_ANGLES = [-90, 0, 90, 180];
export const GRAVITY = 0.26;
export const MAX_PULL = 140;
export const MIN_SPEED = 6, MAX_SPEED = 22;
export const CAT_SPAWN_Y = HUD_H - 10;
export const TYPE_ORDER = ['pelote','artifice','laser','carton'];
export const LEVELS = [
...
export const CONFETTI = ['#ff3ea5','#ffce3a','#26c6f7','#7b3ff2','#ff8a48','#5fcc52','#fff8e6'];
export const SCENES = ['city','garden','home','forest'];
export const FLOATER_COLS = ['#ffd6f2','#fff7c0','#ffffff','#e8d5ff','#ffe1c0','#c8eaff'];
export const HEART_COLS = ['#ff8aba','#ffb3d9','#ff6b9e','#ffa3c4'];
export const FLOATER_SHAPES = ['star','star','sparkle','heart'];
